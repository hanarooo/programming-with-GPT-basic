...
def music_delete():
    delete_song_title = request.args.get("delete_song_title")
    delete_song_username = request.args.get("delete_song_username")
    if delete_song_title and delete_song_username:
        song = Song.query.filter_by(title=delete_song_title, username=delete_song_username).first()
